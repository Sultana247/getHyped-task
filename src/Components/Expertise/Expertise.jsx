        ...
        <div className="h-[410vh] md:h-[550vh] lg:h-[500vh] relative py-25 md:py-75 lg:py-45 ">
            {slides.map((slide, index) => {
                ...
                return (
                    ...
                    >
                        <div className={` p-10 w-full mx-auto  ${slide.bg} rounded-4xl shadow-xl flex flex-col text-4xl  `}>
                            <div className=''>
                                ...
                                <div className='flex flex-col flex-col-reverse lg:flex-row justify-between gap-4 pt-5 mt-4'>
                                    ...
                                    <div>
                                        ...
                                        <p className='pt-5 text-lg font-medium w-[180px] lg:w-[400px] '>{slide.desc}</p>
                                    ...
                                    <div className='relative lg:-top-20'>
                                        <h2 className={slide.id === 1 ? `relative -top-32  lg:top-11 left-25 lg:left-30 md:text-7xl text-5xl lg:text-[80px] font-bold text-amber-950/10` : `relative -top-32 left-25 lg:top-11 lg:left-30 md:text-7xl text-5xl lg:text-[80px] font-bold text-[#FFFFFFBF] opacity-75`}>0{slide.id}</h2>
